...
import type { Campaign, GetAuthResponse } from "@/features/campaigns/types";
import { createApiClients } from "@/shared/lib/api/index";
import { env } from "@/shared/lib/env";
import { protoToCampaign } from "@/shared/lib/proto/campaign";
import { protoRoleToUserRole } from "@/shared/lib/proto/member";
...
export const campaignProcedure = privateProcedure.use(({ next, context }) => {
	...
	return next({
		context: { campaignId: context.campaignId, role: context.role },
	});
});
