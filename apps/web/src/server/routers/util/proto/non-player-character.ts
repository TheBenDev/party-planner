...
export function protoToNpc(proto: Npc) {
	...
	return NonPlayerCharactersSchema.parse({
		...
		currentLocationId: proto.currentLocationId,
		dmNotes: proto.dmNotes,
		foundryActorId: proto.foundryActorId,
		id: proto.id,
		isKnownToParty: proto.isKnownToParty,
		knownName: proto.knownName,
		lastFoundrySyncAt: proto.lastFoundrySyncAt
			? timestampDate(proto.lastFoundrySyncAt)
			: null,
		name: proto.name,
		originLocationId: proto.originLocationId,
		personality: proto.personality,
		playerNotes: proto.playerNotes,
		race: proto.race,
		relationToPartyStatus: protoToRelationToParty(proto.relationToPartyStatus),
		sessionEncounteredId: proto.sessionEncounteredId,
