...
// Swap these for @radix-ui/react-icons or lucide equivalents as needed.
// ---------------------------------------------------------------------------
...
const ALL_INTEGRATIONS = [
	...
	},
	{
		...
		metaIcon: null,
		name: "Foundry VTT",
		source: null, // no source = coming soon, not yet a real integration
	},
	{
		description:
...
export const Route = createFileRoute("/_authenticated/campaign/integrations/")({
