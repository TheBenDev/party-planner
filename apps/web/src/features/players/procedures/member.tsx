...
import InviteMemberEmail from "@/features/players/components/InviteMemberEmail";
import {
			...
			try {
				...
				if (authRes.user) {
					...
					await updateAuthCookie(env.AUTH_PUBLIC_KEY_PEM, context, {
						campaign,
						colonyId: authRes.colonyId ?? null,
						role,
