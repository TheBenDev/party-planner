...
const connectGoogleCalendar = privateProcedure
	.route({
		method: "POST",
...
const disconnectGoogleCalendar = privateProcedure
	.route({
		method: "POST",
...
const getGoogleCalendarStatus = privateProcedure
	.route({
		method: "POST",
...
const checkCalendarConflicts = campaignProcedure
	.route({
		method: "POST",
...
const syncSessionToCalendar = privateProcedure
	.route({
		method: "POST",
