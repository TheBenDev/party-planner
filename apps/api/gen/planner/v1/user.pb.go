...
const file_planner_v1_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x10.planner.v1.UserR\x04user\"a\n" +
	...
	"\vexternal_id\x18\x01 \x01(\tR\n" +
	"externalId\"\x14\n" +
	"\x12DeleteUserResponse2\xd5\x03\n" +
	"\vUserService\x12K\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x1d.planner.v1.UpdateUserRequest\x1a\x1e.planner.v1.UpdateUserResponse\x12K\n" +
	"\n" +
	"DeleteUser\x12\x1d.planner.v1.DeleteUserRequest\x1a\x1e.planner.v1.DeleteUserResponseB\xa6\x01\n" +
...
var file_planner_v1_user_proto_goTypes = []any{
	...
	(*GetUserRequest)(nil),         // 3: planner.v1.GetUserRequest
	(*GetUserResponse)(nil),        // 4: planner.v1.GetUserResponse
	...
	(*GetAuthRequest)(nil),         // 7: planner.v1.GetAuthRequest
	(*GetAuthResponse)(nil),        // 8: planner.v1.GetAuthResponse
	(*UpdateUserRequest)(nil),      // 9: planner.v1.UpdateUserRequest
	(*UpdateUserResponse)(nil),     // 10: planner.v1.UpdateUserResponse
	(*DeleteUserRequest)(nil),      // 11: planner.v1.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 12: planner.v1.DeleteUserResponse
...
var file_planner_v1_user_proto_depIdxs = []int32{
	...
	0,  // 4: planner.v1.GetUserResponse.user:type_name -> planner.v1.User
	0,  // 5: planner.v1.GetUserByEmailResponse.user:type_name -> planner.v1.User
	0,  // 6: planner.v1.GetAuthResponse.user:type_name -> planner.v1.User
	14, // 7: planner.v1.GetAuthResponse.campaign:type_name -> planner.v1.Campaign
	15, // 8: planner.v1.GetAuthResponse.role:type_name -> planner.v1.MemberRole
	0,  // 9: planner.v1.UpdateUserResponse.user:type_name -> planner.v1.User
	1,  // 10: planner.v1.UserService.CreateUser:input_type -> planner.v1.CreateUserRequest
	3,  // 11: planner.v1.UserService.GetUser:input_type -> planner.v1.GetUserRequest
	5,  // 12: planner.v1.UserService.GetUserByEmail:input_type -> planner.v1.GetUserByEmailRequest
	7,  // 13: planner.v1.UserService.GetAuth:input_type -> planner.v1.GetAuthRequest
	9,  // 14: planner.v1.UserService.UpdateUser:input_type -> planner.v1.UpdateUserRequest
	11, // 15: planner.v1.UserService.DeleteUser:input_type -> planner.v1.DeleteUserRequest
	2,  // 16: planner.v1.UserService.CreateUser:output_type -> planner.v1.CreateUserResponse
	4,  // 17: planner.v1.UserService.GetUser:output_type -> planner.v1.GetUserResponse
	6,  // 18: planner.v1.UserService.GetUserByEmail:output_type -> planner.v1.GetUserByEmailResponse
	8,  // 19: planner.v1.UserService.GetAuth:output_type -> planner.v1.GetAuthResponse
	10, // 20: planner.v1.UserService.UpdateUser:output_type -> planner.v1.UpdateUserResponse
	12, // 21: planner.v1.UserService.DeleteUser:output_type -> planner.v1.DeleteUserResponse
...
func file_planner_v1_user_proto_init() {
	...
	file_planner_v1_user_proto_msgTypes[7].OneofWrappers = []any{}
	file_planner_v1_user_proto_msgTypes[8].OneofWrappers = []any{}
	file_planner_v1_user_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
