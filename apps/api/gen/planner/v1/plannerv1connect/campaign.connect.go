...
const (
	...
	CampaignServiceName = "planner.v1.CampaignService"
)
...
const (
	...
	// CreateCampaign RPC.
	CampaignServiceCreateCampaignProcedure = "/planner.v1.CampaignService/CreateCampaign"
...
func NewCampaignServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CampaignServiceClient {
	...
	campaignServiceMethods := v1.File_planner_v1_campaign_proto.Services().ByName("CampaignService").Methods()
...
// GetCampaign calls planner.v1.CampaignService.GetCampaign.
...
func (UnimplementedCampaignServiceHandler) CreateCampaign(context.Context, *connect.Request[v1.CreateCampaignRequest]) (*connect.Response[v1.CreateCampaignResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("planner.v1.CampaignService.CreateCampaign is not implemented"))
}
